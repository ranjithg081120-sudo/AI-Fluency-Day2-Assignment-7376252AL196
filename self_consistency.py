"""Run the same CoT prompt several times and take the majority answer."""
from collections import Counter
from config import client, MODEL, QUESTIONS, banner
from direct_vs_cot import COT_PROMPT
...
if __name__ == "__main__":
    ...
    question = QUESTIONS[1]   # the budget-splitting reasoning question
